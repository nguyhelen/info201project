...
Our data visualization reveals a negative relationship between median household income and police killings across the U.S. The scatter plot illustrates a downward trend, reinforcing the negative correlation. The blue trend line, with its negative slope, suggests that higher-income states generally experience fewer violent police incidents per capita. This points to the possibility that socioeconomic factors may influence the rate of police brutality. When calculating the Pearson correlation coefficient, we found r = -0.37, indicating a moderate negative relationship between the two variables. In other words, as median household income increases, police killings per 100K residents tend to decrease.
...
Our data visualization shows a positive relationship between poverty rates and police killings across each state. The Pearson correlation coefficient calculation yielded r = 0.55, indicating a moderate positive relationship between the two variables. This is reflected in the gold trend line, which has a positive slope, suggesting that as the average poverty rate increases, states generally experience higher violent police incidents per capita.
